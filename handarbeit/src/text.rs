// INFO: This is the text system. It shapes all the glyphs and rasterizes them into very tiny
// rectangles for now. More comments and information in old/
